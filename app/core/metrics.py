...
llm_call_duration_seconds = Histogram(
    'menu_green_llm_call_duration_seconds',
...
rag_search_duration_seconds = Histogram(
    'menu_green_rag_search_duration_seconds',
    'RAG search latency',
    ['search_type']
)
...
memory_cache_misses_total = Counter(
    'menu_green_memory_cache_misses_total',
    'Memory cache misses'
)

memory_cache_size = Gauge(
    'menu_green_memory_cache_size',
    'Current memory cache size'
)

# Error metrics
errors_total = Counter(
    'menu_green_errors_total',
    'Total errors',
    ['error_type', 'endpoint']
)
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args, **kwargs):
            ...
            try:
                ...
                llm_call_duration_seconds.labels(model=model, agent=agent).observe(duration)
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def async_wrapper(*args, **kwargs):
            ...
            try:
                ...
                agent_execution_duration_seconds.labels(agent_name=agent_name, intent=intent).observe(duration)
